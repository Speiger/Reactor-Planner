...
public record ExchangerStats(short id, int self, int reactor, int capacity, List<Vec2i> offsets) {
	...
	public ExchangerStats(short id, int self, int reactor, int capacity) {
		this(id, self, reactor, capacity, DEFAULT_OFFSETS);
	}
}

...
public record UraniumType(int durability, float output, int pulses, int connectivityPulses, float pulseHeatMod, float explosionMod, boolean enriched, List<Vec2i> pulseArea, List<Vec2i> heatArea) {
	...
	public static final UraniumType ENDER = new UraniumType(5000, 2, 1, 1, 0.25F, 2F, true, ENDER_PULSES_AREA, ENDER_HEAT_AREA);
	...
	public UraniumType(int durability, float output, int pulses, int connectivityPulses, float pulseHeatMod, float explosionMod, boolean enriched) {
		this(durability, output, pulses, connectivityPulses, pulseHeatMod, explosionMod, enriched, DEFAULT_AREA, DEFAULT_AREA);
	}
